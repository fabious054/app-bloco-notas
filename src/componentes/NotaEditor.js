...
import { adicionarNota ,atualizarNota,deletaNota} from "../servicos/Notas"
...
export default function NotaEditor({mostraNotas, notaSelecionada,setNotaSelecionada}) {
  ...
  useEffect(() => {
    if (notaSelecionada && notaSelecionada.id){
      preencheModal()
  ...
  return(
    <>
      <Modal
        ...
        onRequestClose={() => {setModalVisivel(true)}}
      >
          ...
          <ScrollView showsVerticalScrollIndicator={false}  >
            <View style={estilos.modal}>
              ...
              <View style={estilos.modalBotoes}>
                <TouchableOpacity onPress={()=>{notaParaAtualizar ? modificaNota() : salvarNota()}} style={estilos.modalBotaoSalvar}>
                  <Text style={estilos.modalBotaoTexto}>Salvar</Text>
                </TouchableOpacity>
                {notaParaAtualizar ?
                  <TouchableOpacity style={estilos.modalBotaoDeletar} onPress={() => {removerNota()}}>
